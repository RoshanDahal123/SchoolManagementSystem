...
namespace SchoolManagementSystem.Infrastructure.SqlRepo.Migrations
{
    ...
    [Migration("20260925092329_AddSectoonHomeRoomTeacher_AcademicYearUnique")]
    partial class AddSectoonHomeRoomTeacher_AcademicYearUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TargetRole", "CreatedAtUtc");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.CourseWork", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClassSubjectId", "DueAtUtc");

                    b.ToTable("Coursework", (string)null);
                });

            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.CourseworkAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CourseworkAttachments", (string)null);
                });

            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.CourseworkSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CourseworkId", "StudentId")
                        .IsUnique();

                    b.ToTable("CourseworkSubmissions", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.SectionHomeroomTeacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SectionId", "AcademicYearId")
                        .IsUnique();

                    b.HasIndex("TeacherId", "AcademicYearId")
                        .IsUnique();

                    b.ToTable("SectionHomeroomTeachers", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.StudentEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.SubmissionAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.TeacherSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.Attendance", b =>
                {
                    ...
                    b.HasOne("SchoolManagementSystem.Domain.Entities.StudentEnrollment", "StudentEnrollment")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.CourseworkAttachment", b =>
                {
                    b.HasOne("SchoolManagementSystem.Domain.Entities.CourseWork", "CourseWork")
            ...
            modelBuilder.Entity("SchoolManagementSystem.Domain.Entities.SubmissionAttachment", b =>
                {
                    b.HasOne("SchoolManagementSystem.Domain.Entities.CourseworkSubmission", "Submission")
                        .WithMany("Attachments")
