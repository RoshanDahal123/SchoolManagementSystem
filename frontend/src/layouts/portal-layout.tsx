...
export function PortalLayout({ navItems, portalTitle, homePath }: PortalLayoutProps) {
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <SidebarMenuItem key={item.path}>
                      <SidebarMenuButton isActive={activeParent} tooltip={item.title} render={<Link to={item.path} />}>
                        <Icon />
                        <span>{item.title}</span>
                      </SidebarMenuButton>
                    </SidebarMenuItem>
